...
const VideoTitle = (props: VideoTitleProps) => {
	...
	return (
		<section className='max-w-[1536px] w-full aspect-video mx-auto pt-[40%] sm:pt-[20%] px-4 sm:px-10 md:px-14 lg:px-20 relative sm:absolute text-white  bg-gradient-to-t from-black/50 z-10'>
